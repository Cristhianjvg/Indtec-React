        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          <div className="bg-muted p-8 rounded-lg">
            <div className="flex items-center gap-3 mb-4">
              <Home className="w-8 h-8 text-[var(--color-orange-accent)]" />
              <h3 className="text-2xl font-bold text-foreground">Artículo Científico</h3>
            </div>
          ...
          <div className="bg-muted p-8 rounded-lg">
            <div className="flex items-center gap-3 mb-4">
              <Monitor className="w-8 h-8 text-[var(--color-orange-accent)]" />
              <h3 className="text-2xl font-bold text-foreground">Ponencias</h3>
            </div>
            <p className="text-muted-foreground leading-relaxed">
